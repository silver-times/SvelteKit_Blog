...
<div class="flex flex-col min-h-screen">
	<div class="flex justify-between navbar bg-[#4A55A2] text-primary-content mx-auto px-5">
	...
	<footer class="footer footer-center p-4 bg-[#4A55A2] text-primary-content mt-auto">
		<div>
